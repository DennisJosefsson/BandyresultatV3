...
export const games = pgTable(
  'games',
  {
    ...
    otResult: varchar('ot_result', { length: 255 }),
...
export const teamgames = pgTable(
  'teamgames',
  {
    ...
    lost: boolean(),
    firstHalfLost: boolean('first_half_lost'),
    secondHalfLost: boolean('second_half_lost'),
    draw: boolean(),
    firstHalfDraw: boolean('first_half_draw'),
    secondHalfDraw: boolean('second_half_draw'),
