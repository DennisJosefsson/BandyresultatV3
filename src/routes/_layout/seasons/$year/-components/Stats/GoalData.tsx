  ...
  return (
    <GameAndGoalCard>
      ...
      <GameAndGoalCard.Content>
        ...
        >
          <PieChart>
            <Pie data={chartData} dataKey="value" nameKey="goals" strokeWidth={5} />

            <ChartLegend
              content={
                <ChartLegendContent className="xs:text-xs flex-col justify-items-center gap-0.5 text-[10px] sm:text-sm" />
              }
            />
          </PieChart>
        </ChartContainer>
