  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-2 lg:gap-4 xl:grid-cols-3 2xl:gap-10">
        <StreakCard streak={data.unbeatenStreak} title="Matcher i rad utan förlust" />
        <StreakCard streak={data.winStreak} title="Matcher i rad med vinst" />
        <StreakCard streak={data.drawStreak} title="Matcher i rad med oavgjort" />
        <StreakCard streak={data.losingStreak} title="Matcher i rad med förlust" />
        <StreakCard streak={data.noWinStreak} title="Matcher i rad utan seger" />
                ...
                >
                  ...
                  <div className="mr-4 flex grow flex-col">
                    <div className="flex flex-row justify-between">
                      <span className="truncate font-semibold">{team.team.name}</span>
                    ...
                    <div className="flex flex-row items-center justify-between text-[10px] md:text-xs">
                      ...
                      <span className="text-right">{team.opponent.shortName}</span>
                    </div>
                  </div>
                </div>
              )
