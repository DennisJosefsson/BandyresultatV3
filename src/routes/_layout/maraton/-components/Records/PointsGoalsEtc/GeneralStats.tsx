  ...
  if (!women) {
    return (
      <div className="flex w-full flex-col lg:w-4/5 2xl:w-2/3">
        <div>
          <h2 className="mb-2 text-sm leading-4 font-bold sm:text-lg lg:text-xl">Säsonger</h2>
        ...
        <div className="flex flex-col">
          <h2 className="mb-2 text-sm leading-4 font-bold sm:text-lg lg:text-xl">Slutspel</h2>
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-4 lg:gap-6">
            <div>
              <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">
                Slutspel sedan 1931
        ...
        <div>
          <div>
            <h2 className="mb-2 text-sm leading-4 font-bold sm:text-lg lg:text-xl">SM-Finaler</h2>
            <div className="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-4 lg:gap-6">
              <div>
                <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">Guld</h3>
                <div>
  ...
  return (
    <div>
      <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
        <div>
          <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">Säsonger</h3>
        ...
        <div>
          <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">Slutspel</h3>
        ...
        <div>
          <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">SM-Guld</h3>
          <div>
            <RenderGeneralStatsCard stat="golds" array={stats.golds} />
          </div>
        </div>
        <div>
          <h3 className="mb-2 text-xs leading-4 font-bold sm:text-base xl:text-lg">Spelade</h3>
          <div>
            <RenderGeneralStatsCard stat="finals" array={stats.finals} />
          </div>
        </div>
