...
export const generatedCupSeries = zd.object({
  seriesArray: zd.array(newCupSeriesObject),
})

export const addGeneratedCupSeries = createServerFn({
  method: 'POST',
})
  .middleware([authMiddleware, errorMiddleware])
  .validator(generatedCupSeries)
