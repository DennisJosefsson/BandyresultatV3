      ...
      <CardContent>
        <div className="flex flex-col gap-2 text-sm xl:text-lg">
          <div className="flex flex-col">
            <div className="flex flex-row items-center justify-between">
              <div>hasQuarter:</div> <div>{playoffSeason.hasQuarter ? 'True' : 'False'}</div>
            </div>
            <div className="flex flex-row items-center justify-between">
              <div>hasEight:</div> <div>{playoffSeason.hasEight ? 'True' : 'False'}</div>
            </div>
            <div className="flex flex-row items-center justify-between">
            ...
            <div className="flex flex-row items-center justify-between">
              <div>uefaSorting:</div> <div>{playoffSeason.uefaSorting ? 'True' : 'False'}</div>
            </div>
          </div>
        </div>
      </CardContent>
