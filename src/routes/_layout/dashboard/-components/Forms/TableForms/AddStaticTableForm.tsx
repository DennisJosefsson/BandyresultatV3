                ...
                <FieldSet className="gap-5">
                  <FieldLegend variant="label">
                    <div className="grid grid-cols-10 gap-2">
                      ...
                      <span className="w-24">Matcher</span>
                      <span className="w-24">Vinst</span>
                      <span className="w-24">Oavgjort</span>
                      <span className="w-24">Förlust</span>
                      <span className="w-24">
                        Gjorda mål
                      </span>
                      <span className="w-24">
                      ...
                      <span className="w-24">Poäng</span>
                    </div>
                  </FieldLegend>
