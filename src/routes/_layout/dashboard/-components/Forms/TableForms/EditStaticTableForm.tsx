  ...
  return (
    <div className="flex min-h-100 flex-col gap-2 p-2">
      <div className="flex flex-row justify-end gap-2">
        <Button type="submit" form="editStaticTableForm">
          Skicka
        </Button>
      </div>
      <form
        id="editStaticTableForm"
        onSubmit={(e) => {
          e.preventDefault()
          form.handleSubmit()
        }}
                ...
                <FieldSet className="gap-5">
                  ...
                  <FieldGroup className="gap-4">
                    {field.state.value.map((team, index) => (
                      <div key={`div-${index}`} className="grid grid-cols-10 gap-2">
                        <FieldLabel
                                ...
                                <FieldContent>
                                  <div className="w-24">
                                    <CustomNumberInput
                                      ...
                                      incrementer={() =>
                                        subField.setValue(subField.state.value + 1)
                                      }
                                      decrementer={() =>
                                        subField.setValue(subField.state.value - 1)
                                      }
                                      error={{
                                        hasErrorField: true,
                                        errorBoolean: isSubFieldInvalid,
...
export default EditStaticTableForm
