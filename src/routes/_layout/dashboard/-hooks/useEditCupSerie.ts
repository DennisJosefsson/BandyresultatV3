...
import { editCupSeriesObject } from '@/lib/types/serie'
...
export const useEditCupSerieForm = () => {
  ...
  const form = useForm({
    validators: {
      onBlur: editCupSeriesObject,
      onSubmit: editCupSeriesObject,
    },
