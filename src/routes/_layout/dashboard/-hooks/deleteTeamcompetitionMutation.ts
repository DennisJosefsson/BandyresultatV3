...
import { removeTeamFromCompetition } from '../-functions/CompetitionFunctions/removeTeamFromCompetition'

type Data = { status: 200; message: string } | undefined

export const deleteTeamcompetitionMutation = (
  dialogRef: RefObject<HTMLDialogElement | null>,
) => {
  const mutation = useMutation({
    mutationFn: removeTeamFromCompetition,
